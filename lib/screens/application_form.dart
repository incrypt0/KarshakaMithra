...
import 'package:farm_app/widgets/dropwdown.dart';
                    ...
                    children: <Widget>[
                      ...
                      RaisedButton(
                          ...
                          onPressed: () {
                            ...
                            print('hai');
                            DatabaseService(uid: user.uid).updateSchemeApplicationData(
                              userid: user.uid,
                              name: name,
                              aadharNo: aadhar,
                              accountNo: accountNo,
                            ...
                            DatabaseService(uid: user.uid).updateSchemeData1(
                                name: widget.scheme.name,
                                id: widget.scheme.id,
                                number: widget.scheme.number,
                                );
                                print(widget.scheme.number);
