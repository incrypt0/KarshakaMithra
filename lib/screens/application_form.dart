...
class _ApplicationFormState extends State<ApplicationForm> {
  ...
  return FutureBuilder(
    ...
    builder: (ctx,AsyncSnapshot<UserData> snap) {
      ...
      snap.data.aadharNo.toString()+'\n'+
      snap.data.address.toString()+'\n'+
      snap.data.accountNo.toString()+'\n'+
      snap.data.pincode.toString()+'\n'+
      snap.data.ifsc.toString()+'\n'+
      snap.data.phoneNo.toString()+'\n'
      // snap.data..toString()+'\n'
      );
      return Scaffold(
                ...
                RaisedButton(
                    ...
                    onPressed: () async {
                     await DatabaseService(uid:user.uid).updateUserData(
                      ...
                      // Scaffold.of(context).showSnackBar(SnackBar(content: Text("Application submitted successfully"),));
                    }),
              ],
            ),
          ),
